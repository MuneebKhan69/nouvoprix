...
const EditeList = () => {
  ...
  return (
    <AppBackground back title={'Edit Product'} notification={false}>
      <ScrollView showsVerticalScrollIndicator={false} style={{flex: 1}}>
        ...
        />
        <CustomTextInputView placeholder={'Wooden Chair'} containerStyle={{color: Colors.grey}} />
        <CustomTextInputView placeholder={'$450'} containerStyle={{color: Colors.grey}} type={'number-pad'} />
        <CustomTextInputView
          placeholder={'Kitchen'}
          down={true}
          value={category}
